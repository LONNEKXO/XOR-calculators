...
public class BinXORCalculator extends JFrame {
    private JTextField binField1, binField2, xorResultField, bitDifferenceField;
    private JButton calculateButton;

    public BinXORCalculator() {
        setTitle("Binary XOR Calculator");
    ...
    private void calculateXORAndDifference() {
        try {
            ...
            xorResultField.setText(Long.toBinaryString(xorResult));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new BinXORCalculator().setVisible(true);
            }
        });
    }
}
